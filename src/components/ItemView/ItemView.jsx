...
export default function ItemView(props) {
  ...
  return (
    <> {!isLoading && <div className="center navbar-margin-top">
...
export function Reviews({ reviews }) {
  return reviews.map((review, idx) => {
    ...
    return (<Review key={idx} comment={review.content} date={review.created_at} rating={review.rating} userName={userName} />)
  })
}
